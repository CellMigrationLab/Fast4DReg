...
// get variables from table (Table.getString(columnName, rowIndex);)

File_Name = Table.getString("Value", 0);
XY_registration = Table.get("Value", 1);
//projection_type = Table.getString("Value", 2);
//time_xy = Table.getString("Value",3);
//max_xy = Table.getString("Value",4);
