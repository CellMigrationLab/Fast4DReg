...
#@ Double (label="x2", value=1, persist=false, style="format:#.##", style="spinner") x2 ;
#@ Double (label="x1", value=2, persist=false, style="format:#.##", style="spinner") x1 ;

#@ String  (value="-----------------------------------------------------------------------------", visibility="MESSAGE") hint1;
#@ Double (label="y2", value=3, persist=false, style="format:#.##", style="spinner") y2 ;
#@ Double (label="y1", value=4, persist=false, style="format:#.##", style="spinner") y1 ;


#@ String  (value="-----------------------------------------------------------------------------", visibility="MESSAGE") hint1;
#@ Double (label="z2", value=0.5, persist=false, style="format:#.##", style="spinner") z2 ;
#@ Double (label="z1", value=-0.5, persist=false, style="format:#.##", style="spinner") z1 ;
...
for (i = 1; i < time_points; i++) {
	...
	selectWindow("3DD_singleFrame");
	// Reslice to swap Z and Y
	run("Reslice [/]...", "output=0.400 start=Top avoid");
	close("3DD_singleFrame");
	selectWindow("Reslice of 3DD_singleFrame");
	rename("3DD_singleFrame");
