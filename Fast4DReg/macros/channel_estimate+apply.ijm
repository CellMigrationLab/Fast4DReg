...
This channel_estimate+apply script estimates the drift between channels in 
a 2D or 3D image(s) stack and applies the correction to the same dataset(s).
...
IJ.log("== Fast4DReg - estimate and apply drift correction - multi-channel images ===========");
